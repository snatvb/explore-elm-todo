...
var author$project$Action$Form = function (a) {
	return {$: 'Form', a: a};
};
var author$project$Action$Form$SetDescription = function (a) {
	return {$: 'SetDescription', a: a};
};
var author$project$Action$Form$SetTitle = function (a) {
	return {$: 'SetTitle', a: a};
};
var author$project$Action$Todo = function (a) {
	return {$: 'Todo', a: a};
};
var author$project$Action$Todo$Add = F2(
	function (a, b) {
		return {$: 'Add', a: a, b: b};
	});
...
var author$project$Form$valid = function (model) {
	return !elm$core$String$isEmpty(model.title);
};
...
var author$project$Form$withSubmit = F2(
	function (model, attrs) {
		return author$project$Form$valid(model) ? A2(
			elm$core$List$cons,
			rtfeldman$elm_css$Html$Styled$Events$onClick(
				author$project$Action$Todo(
					A2(author$project$Action$Todo$Add, model.title, model.description))),
			attrs) : attrs;
	});
...
var author$project$Ui$Form$button = A2(
	...
	_List_fromArray(
		[
			...
			A3(rtfeldman$elm_css$Css$rgb, 39, 174, 96)),
			...
			_List_fromArray(
				[
					...
					rtfeldman$elm_css$Css$backgroundColor(
					A3(rtfeldman$elm_css$Css$rgb, 57, 194, 96))
				])),
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Css$outline(rtfeldman$elm_css$Css$none),
					rtfeldman$elm_css$Css$backgroundColor(
					A3(rtfeldman$elm_css$Css$rgb, 29, 164, 96))
				]))
		]));
...
var author$project$Ui$Form$container = A2(
	rtfeldman$elm_css$Html$Styled$styled,
...
var author$project$Ui$Form$input = A2(
	rtfeldman$elm_css$Html$Styled$styled,
...
var author$project$Ui$Form$row = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
...
var author$project$Form$view = function (model) {
	return A2(
		author$project$Ui$Form$container,
		_List_Nil,
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2(
						author$project$Ui$Form$input,
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Title'),
								rtfeldman$elm_css$Html$Styled$Attributes$value(model.title),
								rtfeldman$elm_css$Html$Styled$Events$onInput(
								A2(elm$core$Basics$composeL, author$project$Action$Form, author$project$Action$Form$SetTitle))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Description'),
								rtfeldman$elm_css$Html$Styled$Attributes$value(model.description),
								rtfeldman$elm_css$Html$Styled$Events$onInput(
								A2(elm$core$Basics$composeL, author$project$Action$Form, author$project$Action$Form$SetDescription))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						A2(
						author$project$Ui$Form$button,
						A2(
							author$project$Form$withSubmit,
							model,
							_List_fromArray(
								[
...
var author$project$Action$Todo$Remove = function (a) {
	return {$: 'Remove', a: a};
};
var author$project$Action$Todo$ToggleComplited = function (a) {
	return {$: 'ToggleComplited', a: a};
};
...
var author$project$Main$onStopClick = function (message) {
	return A2(
...
var author$project$Main$renderPureHtml = F2(
	function (ja, ma) {
		return A2(
			elm$core$List$append,
			ja,
...
var author$project$Ui$Todo$description = F2(
	function (attrs, msg) {
		return A4(
			rtfeldman$elm_css$Html$Styled$styled,
			rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Ui$Todo$complited = function (isComplited) {
	return isComplited ? rtfeldman$elm_css$Css$batch(
		_List_fromArray(
			[
...
var author$project$Ui$Todo$item = function (isComplited) {
	return A2(
		rtfeldman$elm_css$Html$Styled$styled,
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$px(12),
				rtfeldman$elm_css$Css$px(15)),
				author$project$Ui$Todo$complited(isComplited),
...
var author$project$Ui$Todo$removeButton = function (attrs) {
	return A4(
		rtfeldman$elm_css$Html$Styled$styled,
		rtfeldman$elm_css$Html$Styled$button,
		_List_fromArray(
			[
				...
				rtfeldman$elm_css$Css$textAlign(rtfeldman$elm_css$Css$center),
				rtfeldman$elm_css$Css$backgroundColor(
				A3(rtfeldman$elm_css$Css$rgb, 199, 0, 57)),
				rtfeldman$elm_css$Css$border(
				rtfeldman$elm_css$Css$px(0)),
				rtfeldman$elm_css$Css$width(
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$cursor(rtfeldman$elm_css$Css$pointer),
						rtfeldman$elm_css$Css$backgroundColor(
						A3(rtfeldman$elm_css$Css$rgb, 210, 12, 80))
					])),
				rtfeldman$elm_css$Css$focus(
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$outline(rtfeldman$elm_css$Css$none),
						rtfeldman$elm_css$Css$backgroundColor(
						A3(rtfeldman$elm_css$Css$rgb, 179, 0, 47))
					]))
			]),
		attrs,
		_List_fromArray(
...
var author$project$Ui$Todo$title = F2(
	function (attrs, msg) {
		return A4(
			rtfeldman$elm_css$Html$Styled$styled,
			rtfeldman$elm_css$Html$Styled$div,
...
var author$project$Main$renderTodo = F2(
	function (index, todo) {
		return A3(
			author$project$Ui$Todo$item,
			todo.complited,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Events$onClick(
					author$project$Action$Todo(
						author$project$Action$Todo$ToggleComplited(index)))
				]),
			A2(
				author$project$Main$renderPureHtml,
				_List_fromArray(
					[
						A2(author$project$Ui$Todo$title, _List_Nil, todo.title),
						author$project$Ui$Todo$removeButton(
						_List_fromArray(
							[
								author$project$Main$onStopClick(
								author$project$Action$Todo(
									author$project$Action$Todo$Remove(index)))
							]))
					]),
				_List_fromArray(
					[
						A2(
						elm$core$Maybe$map,
						author$project$Ui$Todo$description(_List_Nil),
						todo.description)
					])));
	});
var author$project$Main$renderTodos = function (model) {
	return (elm$core$List$length(model.todos) > 0) ? A2(elm$core$List$indexedMap, author$project$Main$renderTodo, model.todos) : _List_fromArray(
		[
			rtfeldman$elm_css$Html$Styled$text('No one todo item')
		]);
};
var author$project$Ui$container = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
...
var author$project$Ui$title = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
...
var author$project$Ui$Todo$container = A2(
	rtfeldman$elm_css$Html$Styled$styled,
	rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text('To do with elm!')
					])),
				A2(
				author$project$Ui$Todo$container,
				_List_Nil,
				author$project$Main$renderTodos(model)),
				author$project$Form$view(model.form)
			]));
};
var author$project$Store$initialModel = {
	form: {description: '', title: ''},
	todos: _List_fromArray(
		[
			{complited: false, description: elm$core$Maybe$Nothing, title: 'Hello world!'},
			{
			complited: true,
			description: elm$core$Maybe$Just('This is description'),
			title: 'I made that'
		}
		])
};
var author$project$Store$updateForm = F2(
	function (action, model) {
		switch (action.$) {
			case 'SetDescription':
				var description = action.a;
...
var author$project$Action$Form$Reset = {$: 'Reset'};
var author$project$Store$setComplited = F2(
	function (isComplited, todo) {
		return _Utils_update(
			todo,
...
var author$project$Store$setAtMaybe = F3(
	function (index, m, list) {
		if (m.$ === 'Just') {
			var value = m.a;
			return A3(elm_community$list_extra$List$Extra$setAt, index, value, list);
		} else {
			return list;
		}
	});
...
var author$project$Store$setComplitedByIndex = F3(
	function (todos, index, mapTodo) {
		var todo = A2(
			elm$core$Maybe$map,
			mapTodo,
			A2(elm_community$list_extra$List$Extra$getAt, index, todos));
		return A3(author$project$Store$setAtMaybe, index, todo, todos);
	});
var author$project$Store$toggleComplited = function (todo) {
	return _Utils_update(
		todo,
...
var author$project$Store$updateTodos = F2(
	function (action, model) {
		switch (action.$) {
			case 'Add':
				var title = action.a;
				var description = action.b;
				return _Utils_update(
					model,
					{
						form: A2(author$project$Store$updateForm, author$project$Action$Form$Reset, model.form),
						todos: A2(
							elm$core$List$cons,
							{
								complited: false,
			...
			case 'Complete':
				...
				return _Utils_update(
					...
					{
						todos: A3(
							author$project$Store$setComplitedByIndex,
							model.todos,
							id,
							author$project$Store$setComplited(true))
					});
			case 'ToggleComplited':
				var id = action.a;
				return _Utils_update(
					model,
					{
						todos: A3(author$project$Store$setComplitedByIndex, model.todos, id, author$project$Store$toggleComplited)
					});
			default:
				var id = action.a;
				return _Utils_update(
					model,
					{
						todos: A2(elm_community$list_extra$List$Extra$removeAt, id, model.todos)
					});
		}
	});
var author$project$Store$update = F2(
	function (action, model) {
		if (action.$ === 'Form') {
			var formAction = action.a;
			return _Utils_update(
				model,
				{
					form: A2(author$project$Store$updateForm, formAction, model.form)
				});
		} else {
			var todoAction = action.a;
			return A2(author$project$Store$updateTodos, todoAction, model);
		}
	});
...
var author$project$Main$main = elm$browser$Browser$sandbox(
	{
		init: author$project$Store$initialModel,
		update: author$project$Store$update,
